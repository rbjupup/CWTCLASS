...
// Ini.h: interface for the YCIni class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_YCINI_H__4A8E7C07_902F_11D1_8B70_0000B43382FE__INCLUDED_)
#define AFX_YCINI_H__4A8E7C07_902F_11D1_8B70_0000B43382FE__INCLUDED_
...
public:
	...
	bool SetValue(const char * cSection, const char * cItem, const CFloatPt ptVal);
	...
	bool GetValue(const char * cSection, const char * cItem, CFloatPt &ptVal);
	void Clear();

...
public:
	...
	void OnDrawChartLegendKey(CBCGPGraphicsManager* pGM, const CBCGPRect& rectLegendKey, 
		const BCGPChartFormatSeries* pSeriesStyle, CBCGPChartSeries* pSeries, int nDataPointIndex);
...
class BCGCBPRODLLEXPORT CBCGPStockChartImpl : public CBCGPBaseChartImpl
{
...
public:
	...
	CBCGPStockChartImpl(CBCGPChartVisualObject* pRelatedChartControl) : CBCGPBaseChartImpl(pRelatedChartControl)
	{
	}

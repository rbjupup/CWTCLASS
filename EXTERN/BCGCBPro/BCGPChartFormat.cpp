...
void CBCGPChartTheme::SetTheme(CBCGPChartTheme::ChartTheme chartTheme)
{
	...
	case CT_BLACK_AND_GOLD:
		InitChartColors(*this, CBCGPColor::Black, CBCGPColor::DarkGoldenrod, CBCGPColor::Goldenrod, colorNull, colorPlotBlack);
	...
	case CT_BLACK_AND_RED:
		InitChartColors(*this, CBCGPColor::Black, CBCGPColor::LightCoral, colorNull, colorNull, colorPlotBlack);

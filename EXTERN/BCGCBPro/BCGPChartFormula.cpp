...
{
	m_pParentSeries = new CBCGPChartLineSeries(pChart, strFormulaName);
	pChart->AddSeries(m_pParentSeries);
...
void CBCGPChartAdvancedFormula::UpdateLastDataPoints(int nCount)
{
	...
	{
		CBCGPChartValue valY = CalculateDataPoint(i, pInputSeries);
		...
		if (m_pParentSeries->GetDataPointCount() - 1 < i)
		{
			...
			{
				m_pParentSeries->AddDataPoint(valY.GetValue());
			}
			else if (!valY.IsEmpty())
			{
				m_pParentSeries->AddDataPoint(valY.GetValue(), valX.GetValue());
			}
		}
		else
		{
...
//*******************************************************************************
CBCGPChartValue CBCGPChartMAFormula::CalculateDataPoint(int nIndex, CBCGPChartSeries* pInputSeries)
{
	double dblY = 0.;
...
//*******************************************************************************
CBCGPChartValue CBCGPChartRSIFormula::CalculateDataPoint(int nIndex, CBCGPChartSeries* pInputSeries)
{
...
//*******************************************************************************
CBCGPChartValue CBCGPChartStochasticFormula::CalculateDataPoint(int nIndex, CBCGPChartSeries* pInputSeries)
{
